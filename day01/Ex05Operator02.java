...
public class Ex05Operator02 {
	public static void main(String[] args) {
		...
		//2. "number의 현재 값: " + ++number
		//   number의 현재 값: 뒤에 number의 현재값을 1 늘린 값을 붙여라
		// ->number의 현재 값: 11
		//3. System.out.println("number의 현재 값: " + ++number)
		// -> 괄호안의 내용을 화면에 출력해라
		...
		//위의 코드는
		//1. "number의 현재 값: " 뒤에 number를 붙여준다.
		//2. 화면에 괄호안의 내용을 화면에 출력한다.
