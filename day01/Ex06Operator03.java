...
public class Ex06Operator03 {
	public static void main(String[] args) {
		...
		// 하지만 비교 연산자를 사용할때는 한가지 주의할 것이 있다.
		// 기본형 변수에서만 정확한 값이 나올 수 있다.
		// 참조형 변수에서는 틀린 값이 나오게 된다.

		// String은 여러 문자를 한번에 다루는 클래스이다.
		// String 변수를 만들어서 그안의 값을 비교해보자
		String string1 = "abc";
		String string2 = new String("abc");
		String string3 = string1;

		System.out.println("string1의 현재 값: " + string1);
		System.out.println("string1의 현재 값: " + string2);
		System.out.println("string1의 현재 값: " + string3);
		...
		//참조형 변수는 해당 공간에 값이 아닌 그 주소값만 들어가 있고
		//그 주소값을 "참조"해서 다른 공간을 확인해야
		//실제 값을 확인할 수 있다.
		
		//하지만 비교연산자는 주소값을 타고 들어가서 실제 값을 확인하는게 아니라
		//주소값 자체를 비교해버린다.
		
		//따라서 우리는 참조형 변수를 비교할 때에는 비교연산자 대신 다른 방법을 사용해야한다.
		//바로 해당 참조형 변수에 정의되어있는 메소드를 호출해서 변경해야한다.
