...
public class Ex02LottoArray {
	...
	public static void main(String[] args) {
		...
		//이클립스에서 자동완성은
		//ctrl과 space를 동시에 누르면 된다.
		//랜덤 + 자동완성 해서 java.util.Random을 import하자
		Random random = new Random();
		//random은 난수를 만드는데 쓰이는 Random 클래스의 객체이다.
		...
		//i의 값을 다시 넣고
		//그리고 처음으로 돌아거서 다시 검사하는 코드를 만들어 보자!
		for(int i = 0; i < array.length; i++) {
