...
public class Ex01Array {
	public static void main(String[] args) {
		...
		//index는 0부터 배열의 크기 - 1까지이다.
		
		//배열의 각 위치는 우리가 번호를 적어주면 하나의 변수처럼 사용이 가능하다
		arr[0] = 30;
		System.out.println("0번째의 값: "+arr[0]);
		...
		//만약 우리가 배열에 존재하지 않는 번호를 접근할려고 한다면?
		//System.out.println(arr[30]);
		//위의 코드는 에러가 난다. 왜냐하면 배열의 크기가 5인데
		//index 30이라는 범위를 벗어난 위치를 접근할려고 했기 때문이다.
		//즉 우리가 숫자를 입력 받아서 저장하는 프로그램을 작성할려고 한다면
		//배열로 만들면 횟수가 제한된다.
		
		//여러분들이 직접 동적할당과 정적할당의 차이를 조사해보세요.
		...
		//위 코드에서는 null pointer exception이 발생한다.
