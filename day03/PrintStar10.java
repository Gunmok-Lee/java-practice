	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 2 * userNumber - 1; i++) {
			...
			if (i == 1 || i == 2 * userNumber - 1) {
				// 가장 윗줄 or 마지막 줄이므로
				// 별을 2 * userNumber -1개만큼 stars에 추가한다.
				...
				// 해당줄의 별의 갯수는 왼쪽 별 + 오른쪽 별이고
				// 한쪽 별의 갯수는 lowerI 개 이다.
				// 결국 한 줄의 별의 갯수는 2*lowerI가 된다.
				// 따라서 공백의 갯수는
				// 2*userNumber-1-2*liwerI개가 된다.
				// 위의 식을 좀 더 간단히 쓰면
				// 2*(userNumber - lowerI) - 1 이 된다.
