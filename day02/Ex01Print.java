...
// 1. print()
//    print()는 괄호안의 내용을 출력하고 다음 출력위치를 바꾸지 않는다.
// 2. println()
//    println() print a line의 줄임말로써, 괄호안의 내용을 출력하고
//    다음 출력위치를 다음 줄로 바꾼다.
// 3. printf()
//    printf() 는 print in format의 줄임말로써, 괄호안의 내용을 출력하되
//    %문자를 이용해서 형식을 지정해 줄 수 있다. 단 출력위치는 바뀌지 않는다.
...
public class Ex01Print {
	public static void main(String[] args) {
		...
		//printf는 얼핏보면 print와 비슷하지만 내부의 내용을 형식을 지정해 줄 수 있다.
