	...
	private void endPark() {
		...
		if (controller.isEmpty()) {
			...
			while (!controller.contains(p)) {
				...
				// p가 존재하지 않으므로
				// 다시 입력받는다
				System.out.println("주차되지 않은 차량 번호 입니다.");
				System.out.print("출차할 차량의 번호를 입력해주세요: ");
				p.setCarNum(scanner.nextLine());
			}
